...
const CreatorHome = () => {
  ...
  return (
    <div className="p-2">
      <div className="">
        <CreatorCard submissions={submissions} userData={userData} tasks={tasks} />
                  ...
                  <tr key={task._id}>
                    ...
                    <td className="px-3 py-2">
                      ...
                      <div className="modal" role="dialog">
                        <div className="modal-box">
                          <h3 className="text-lg font-bold">Worker Submissions</h3>
                    ...
                    <td className="px-3 py-2">
                      <div className="dropdown dropdown-hover">
                        ...
                        >
                          <li onClick={() => handleApprove(task)} className="bg-green-400 rounded-xl">
                            <button>Accept</button>
                          </li>
                          <li onClick={() => handleRejecting(task._id)} className="bg-red-400 rounded-xl">
