      ...
      <div className="w-full lg:w-6/12 px-4">
        ...
        <div className="mt-6 lg:mb-0 mb-6">
          ...
          <button className="bg-white text-red-500 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
            ...
            <a href="https://www.facebook.com/profile.php?id=100024676355421" target="blank">
            <button className="bg-white text-lightBlue-600 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2" type="button">
            <i className="fab fa-facebook-square"></i></button>
            </a>
            
           <a href="https://www.linkedin.com/in/saidul-houlader/" target="blank">
    ...
    <div className="flex flex-wrap items-center md:justify-between justify-center">
      <div className="w-full md:w-4/12 px-4 mx-auto text-center">
        <div className="text-sm text-blueGray-500 font-semibold py-1">
          Copyright © <span id="get-current-year">2021</span><a href="" className="text-blueGray-500 hover:text-gray-800" target="_blank"> by</a>
          <a href="" className="text-blueGray-500 hover:text-blueGray-800"> MicroEarn</a>
        </div>
      </div>
    </div>
  </div>
